...
def main():
    ...
    lst_joint_angles_2 = [math.radians(-103),
                          math.radians(-32),
                          math.radians(87),
                          math.radians(36),
                          math.radians(90),
    ...
    lst_joint_angles_3 = [math.radians(-103),
                          math.radians(-25),
                          math.radians(82),
                          math.radians(37),
                          math.radians(90),
    ...
    lst_joint_angles_4 = [math.radians(150),
                          math.radians(-33),
                          math.radians(82),
                          math.radians(37),
                          math.radians(90),
    ...
    lst_joint_angles_5 = [math.radians(150),
                          math.radians(-23),
                          math.radians(82),
                          math.radians(37),
                          math.radians(90),
    ...
    while not rospy.is_shutdown():
        ...
        ur5.go_to_predefined_pose("closed")
