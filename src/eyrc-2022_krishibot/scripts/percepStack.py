...
path = "/home/vedh/catkin_ws/src/eyrc-2022_krishibot/scripts/c_image.jpeg"
img = cv2.imread(path)
imgContour = img.copy()
image = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)
imgBlur = cv2.GaussianBlur(image, (17, 17), 1)
...
imgStack = stackImages(0.8, ([imgBlur, thresh2],
                             [imgCanny, imgContour]))

img_resize=cv2.resize(imgStack, (1500, 300))
...
#     image1=cv2.imread('/home/vedh/catkin_ws/src/eyrc-2022_krishibot/scripts/c_image2.jpeg')
